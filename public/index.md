...
- **crash-dummy** — Takes your repo for a test drive. Builds a synthetic customer app from your docs alone, runs the flows your users will run, and reports what breaks. [GitHub](https://github.com/katrinalaszlo/crash-dummy)
- **glowup** — A design skill for the terminal. Applies product-design principles to the display and flow of a CLI, dev tool, or agent skill. [GitHub](https://github.com/katrinalaszlo/glowup)
