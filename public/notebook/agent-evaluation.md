...
## Manual checks and repeatable evals
...
Write test cases, run them on each change, and compare the results across versions. Add new cases when production exposes something you missed.

| Dimension | Vibes | Systematic |
| --- | --- | --- |
...
> **The real cost:** Without repeatable tests, it's hard to tell whether a prompt change helped one case and broke another.
...
| Layer | What It Tests | Failure Looks Like |
| --- | --- | --- |
...
> The tools below cover test runs, tracing, annotation, and experiment tracking.
...
> Add production failures to the suite and remove cases that no longer match the product.
