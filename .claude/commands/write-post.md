...
Write ready-to-post copy for each platform. Save to a temporary file so user can copy-paste.
...
Save all distribution copy to `/tmp/distribute-{slug}.md` for easy access.
...
- Distribution copy: `/tmp/distribute-{slug}.md`
